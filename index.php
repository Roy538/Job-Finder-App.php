        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              ...
              <p>Make your mark in the professional world By Build the career of your dreams.</p>
            </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p class="lead text-white">Find meaningful work that inspires you and Explore diverse career options..</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-8">
            ...
            <p class="mb-0 text-white lead">Join our community of job seekers.<br>Your career starts here.</p>
          </div>
          <div class="col-md-3 ml-auto">
            <a href="./auth/register.php" class="btn btn-warning btn-block btn-lg" onclick="Warn();">Sign Up</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row align-items-center">
          <div class="col-12 text-center mt-4 mb-5">
            <div class="row justify-content-center">
              <div class="col-md-7">
                <h2 class="section-title mb-2">Company We've Partnered With...</h2>
                <p class="lead">Make your mark in the professional world to Explore diverse career options.</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 align-self-center text-center text-md-left mb-5 mb-md-0">
            ...
            <p class="mb-5 lead text-white">The mobile responsiveness of this website is fantastic. You can easily Navigate on your phone without any issues.</p>
            <p class="mb-0">
...
<?php require "includes/footer.php"; ?>
  ...
  <script type="text/javascript">
      function Warn(){
        alert("To sign Up With Us Kindly Visit Our 'REGISTER' Page.");
      }
  </script>